...
public class RubyBlockBlock extends ExtraToolsModElements.ModElement {
	@ObjectHolder("extra_tools:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(ExtraToolsModElements instance) {
		super(instance, 113);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2f, 12f).setLightLevel(s -> 0));
