...
public class RubyOreBlock extends ExtraToolsModElements.ModElement {
	@ObjectHolder("extra_tools:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(ExtraToolsModElements instance) {
		super(instance, 90);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("extra_tools:ruby_ore_match"), () -> CustomRuleTest.codec);
