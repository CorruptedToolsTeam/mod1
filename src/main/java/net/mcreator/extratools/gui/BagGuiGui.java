...
public class BagGuiGui extends ExtraToolsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public BagGuiGui(ExtraToolsModElements instance) {
		super(instance, 112);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 38, 35) {
			}));
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 70, 35) {
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 103, 35) {
			}));
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 134, 35) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
