...
import net.mcreator.extratools.entity.renderer.CubeoffunRenderer;
import net.mcreator.extratools.ExtraToolsModElements;

@ExtraToolsModElements.ModElement.Tag
public class CubeoffunEntity extends ExtraToolsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f))
					.build("cubeoffun").setRegistryName("cubeoffun");
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletcubeoffun").setRegistryName("entitybulletcubeoffun");
	public CubeoffunEntity(ExtraToolsModElements instance) {
		super(instance, 57);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CubeoffunRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3407872, -13382656, new Item.Properties().group(ExtraStuffItemGroup.tab))
				.setRegistryName("cubeoffun_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 70, 1, 6));
	}
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, CorruptedpillagerEntity.CustomEntity.class, true, true));
			...
			this.goalSelector.addGoal(7, new TemptGoal(this, 1, Ingredient.fromItems(Items.SLIME_BALL), false));
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (Items.SLIME_BALL == stack.getItem())
				return true;
			return false;
		}
