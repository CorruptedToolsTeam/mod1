...
import net.mcreator.extratools.entity.renderer.VillagerOutcastRenderer;
import net.mcreator.extratools.ExtraToolsModElements;

@ExtraToolsModElements.ModElement.Tag
public class VillagerOutcastEntity extends ExtraToolsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.95f)).build("villager_outcast").setRegistryName("villager_outcast");
	public VillagerOutcastEntity(ExtraToolsModElements instance) {
		super(instance, 124);
		FMLJavaModLoadingContext.get().getModEventBus().register(new VillagerOutcastRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3381760, -65485, new Item.Properties().group(ExtraStuffItemGroup.tab))
				.setRegistryName("villager_outcast_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 20, 4, 12));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(Items.IRON_AXE));
		}
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, CorruptedpillagerEntity.CustomEntity.class, true, true));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(RubyItem.block));
		}
