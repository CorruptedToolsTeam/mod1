...
import net.mcreator.extratools.entity.renderer.PirateRenderer;
import net.mcreator.extratools.ExtraToolsModElements;

@ExtraToolsModElements.ModElement.Tag
public class PirateEntity extends ExtraToolsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("pirate").setRegistryName("pirate");
	public PirateEntity(ExtraToolsModElements instance) {
		super(instance, 126);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PirateRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -16776961, new Item.Properties().group(ExtraStuffItemGroup.tab))
				.setRegistryName("pirate_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(Items.IRON_SWORD));
		}
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, CorruptedpillagerEntity.CustomEntity.class, true, true));
