...
public class PirateShipStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 10000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("extra_tools", "pirate_ship"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("pirate_ship"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("extra_tools:pirate_ship"), configuredFeature);
		}
	}
	@SubscribeEvent
