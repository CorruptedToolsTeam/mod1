...
public class VolcanicDestructionBiome extends ExtraToolsModElements.ModElement {
	public static Biome biome;
	public VolcanicDestructionBiome(ExtraToolsModElements instance) {
		super(instance, 120);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-10066330).setWaterColor(-16777216).setWaterFogColor(-13421773)
						.withSkyColor(-10066330).withFoliageColor(-16777216).withGrassColor(-16777216)
						.setParticle(new ParticleEffectAmbience(ParticleTypes.ASH, 0.008f)).build();
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.NONE).depth(0.1f).scale(0.2f).temperature(1.4f)
						.downfall(0f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("extra_tools:volcanic_destruction"));
			}
		}
	}
	@Override
