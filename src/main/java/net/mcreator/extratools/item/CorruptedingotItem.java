...
public class CorruptedingotItem extends ExtraToolsModElements.ModElement {
	@ObjectHolder("extra_tools:corruptedingot")
	public static final Item block = null;
	public CorruptedingotItem(ExtraToolsModElements instance) {
		super(instance, 47);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("corruptedingot");
		}
