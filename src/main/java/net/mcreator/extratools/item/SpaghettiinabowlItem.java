...
public class SpaghettiinabowlItem extends ExtraToolsModElements.ModElement {
	@ObjectHolder("extra_tools:spaghettiinabowl")
	public static final Item block = null;
	public SpaghettiinabowlItem(ExtraToolsModElements instance) {
		super(instance, 20);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("spaghettiinabowl");
		}
