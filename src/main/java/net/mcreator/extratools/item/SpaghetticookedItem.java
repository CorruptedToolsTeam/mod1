...
public class SpaghetticookedItem extends ExtraToolsModElements.ModElement {
	@ObjectHolder("extra_tools:spaghetticooked")
	public static final Item block = null;
	public SpaghetticookedItem(ExtraToolsModElements instance) {
		super(instance, 18);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("spaghetticooked");
		}
