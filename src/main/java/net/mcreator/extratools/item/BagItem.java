...
import net.mcreator.extratools.gui.BagGuiGuiWindow;
import net.mcreator.extratools.gui.BagGuiGui;
...
public class BagItem extends ExtraToolsModElements.ModElement {
	@ObjectHolder("extra_tools:bag")
	public static final Item block = null;
	public BagItem(ExtraToolsModElements instance) {
		super(instance, 112);
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(ExtraStuffItemGroup.tab).maxStackSize(1).rarity(Rarity.UNCOMMON));
			setRegistryName("bag");
		}
