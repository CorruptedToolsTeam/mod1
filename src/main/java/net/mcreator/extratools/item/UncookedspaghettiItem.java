...
public class UncookedspaghettiItem extends ExtraToolsModElements.ModElement {
	@ObjectHolder("extra_tools:uncookedspaghetti")
	public static final Item block = null;
	public UncookedspaghettiItem(ExtraToolsModElements instance) {
		super(instance, 16);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("uncookedspaghetti");
		}
